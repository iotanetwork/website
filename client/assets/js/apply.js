...
// });
$('input[name="hours"]').datetimepicker({
    format: 'DD/MM/YYYY'
});
});
...
var values = [new Date().toISOString(), applyData['firstName'], applyData['country'], applyData['city'], applyData['interestedAreasIn'], applyData['socialAccounts']['discord'], applyData['profession'], applyData['email'], applyData['socialAccounts']['linkedin'], applyData['personalWebsite'], applyData['whyIEN'], applyData['lastName'], applyData['resume'], applyData['acknowledgement'], applyData['socialAccounts']['telegram'], applyData['generalIota'], applyData['generalDlt'], applyData['perWeek'], applyData['verticals'], '', applyData['hours'], applyData['rateIota']];
